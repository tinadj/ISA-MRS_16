                ...
                <b-card style="max-width: 62rem;">
                    ...
                    <ul>
                        <li v-for="item in hotels">
                            <UnregisteredUserHotelsInfo v-bind:item="item"></UnregisteredUserHotelsInfo>
                        </li>
                    </ul>
                </b-card>
            </b-card-group> 
...
<script>
    ...
    import UnregisteredUserHotelsInfo from './unregistered_hotelInfo'

    export default {
        name: 'UnregisteredUserSearchHotels',
        components: {
            UnregisteredUserHotelsInfo
        },
        data()
        {
            return {
