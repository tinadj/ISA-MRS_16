						...
						<div class="col-xs-12 col-sm-9">
							...
							<div class="profile-user-info">
                                ...
                                <div class="profile-info-row">
									<div class="profile-info-value">
										<span>
                                            <b-link v-on:click="locations = !locations"><font-awesome-icon :icon="destinationsIcon"/>  Destinations...</b-link>
                                            <b-modal v-model="locations" hide-footer>
                                                <template slot="modal-title">List of destinations</template>
                                                <b-card-group deck>
                                                    <b-card border-variant="light" style="overflow-y:scroll;">
                                                        <p class="text-left">      
                                                            <ul>
                                                                <li v-for="d in item.destinations">
...
export default {
    name: 'RegisteredUserAirlineInfo',
    props: ["item"],
    data() {
        return {
            ...
            destinationsIcon: faMapMarkedAlt,
            rating: 0,
            details: false,
            locations: false
        } 
