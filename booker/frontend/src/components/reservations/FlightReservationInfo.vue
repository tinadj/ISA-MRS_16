						...
						<div class="col-xs-12 col-sm-9">
							...
							<div class="profile-user-info">
								...
								<div class="profile-info-row">
                                    <div class="profile-info-name"> Flight: </div>
									<div class="profile-info-value">
										<span>
                                            <h5>{{reservation.flight.id}} &nbsp
                                                <star-rating  :inline="true" :star-size="17" :show-rating="false"  :round-start-rating="false"></star-rating>
                                            </h5>
                                            <br />
                                            {{ reservation.arrivalDestination.city }} - {{ reservation.departureDestination.city }}
                                        </span>
									</div>
								</div>

                                <div class="profile-info-row">
                                    <div class="profile-info-name"> Checked luggage: </div>
									<div class="profile-info-value">
										<span>
                                           {{reservation.checked}
                                        </span>
                                ...
                                <div class="profile-info-row">
                                    <div class="profile-info-name"> Carry-on luggage: </div>
									<div class="profile-info-value">
										<span>
                                           {{reservation.carryOn}}
                                        </span>
