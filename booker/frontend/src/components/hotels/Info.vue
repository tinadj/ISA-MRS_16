							...
							<div class="profile-user-info">
								...
								<div class="profile-info-row">
									<div class="profile-info-value">									
                                        <span><b>{{item.name}}</b> <br> <star-rating :show-rating="false" :inline="true" v-model="rating" :read-only="true" :round-start-rating="false" :star-size="20" > </star-rating> </span>
									</div>
								</div>
                                ...
                                <div class="profile-info-row">
									<div class="profile-info-value">
										<span><b-link>Show more details...</b-link></span>
									</div>
								</div>
